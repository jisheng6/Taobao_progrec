package com.example.adminjs.taobao_progect.gouwuche.adapter;
...
import com.example.adminjs.taobao_progect.gouwuche.view.PlusView;
...
//            map.get（）取到 商家的名称
    ...
    private void sum(List<ShopBean.DataBean.ListBean> list){
        ...
        listener.setTotal("总价:"+totalMoney+"","总数量:"+totalNum+"",allCheck);
    }
